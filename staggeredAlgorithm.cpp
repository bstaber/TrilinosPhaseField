...
TPF::staggeredAlgorithm::::TPF::staggeredAlgorithm::(){
}

TPF::staggeredAlgorithm::::~TPF::staggeredAlgorithm::(){
}

void TPF::staggeredAlgorithm::::initialize(Epetra_Comm & comm, Teuchos::ParameterList & Parameters){
...
void TPF::staggeredAlgorithm::::staggeredAlgorithmDirichletBC(Teuchos::ParameterList & ParametersList,
                                                                   bool print){
